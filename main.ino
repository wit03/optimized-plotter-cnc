/*
Main Code:
  1. please calibrated first then come to this Code
  2. If you calibrated your CNC put the steps per mil below (x and y usually the same value)
 */
#include <Servo.h>
#include <AFMotor.h>
...
float StepsPerMillimeterX = 14.2;
float StepsPerMillimeterY = 14.2;
